...
class DiyReasoning_APIPipeline(StreamBatchedPipelineABC):
    def __init__(self, llm_serving: LLMServingABC = None):
        ...
        self.storage = StreamBatchedFileStorage(
            # 指向你的具体文件路径
            first_entry_file_name="/share/project/miaode/infini/training_code/DataFlow/workspace/results_for_infini/mol_instruct/mol_instruct_step_step1.jsonl",
            cache_path="/share/project/miaode/infini/training_code/DataFlow/workspace/results_for_infini/mol_instruct",
            file_name_prefix="mol_instruct_newstep_",
